       ...
       // board.printBoard(board.getPrintMatrix());
        ...
        while (!winTray.winCheck()) {
            ...
            while (true) {
                ...
                if (board.getMatrix()[row][col] == currentPlayer) break; // Valid selection
                System.out.println("Invalid selection! Choose one of your own pieces.");
            }
            ...
            while (true) {
                ...
                if (board.getMatrix()[row2][col2] == currentPlayer) break;
                System.out.println("Invalid selection! Choose one of your own pieces.");
            }
